// src/components/NotificationsTableComponent/NotificationsSearchFilterDrawer.jsx
...
const NotificationsSearchFilterDrawer = ({
    open,
    onClose,
    filterConfig,
    sortOptions,
...
export default NotificationsSearchFilterDrawer;
