...
const getManageOptinsTableColumns = ({
    handleView,
    handleEdit,
    handleDelete,
}) => {
    ...
    return [
        {
            ...
            render: (_, record) => (
                <div style={{ display: "flex", alignItems: "center" }}>
                    ...
                    >
                        {record.title?.charAt(0) || "O"}
                    </Avatar>
                    <div style={{ marginLeft: 12 }}>
                        <div style={{ fontWeight: 500 }}>
                            {record.title || "Untitled Optin"}
                        </div>
        ...
        },
        {
            ...
            render: (_, record) => {
                ...
                if (can("optins", "delete") && handleDelete) {
                    items.push({
                        key: "delete",
                        label: "Delete",
                        icon: <DeleteOutlined />,
...
export default getManageOptinsTableColumns;
