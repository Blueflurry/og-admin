...
const ManageOptinsSearchFilterDrawer = ({
    open,
    onClose,
    onApplyFilters,
    initialValues = {},
    ...
    const formatInitialValues = (values) => {
        ...
        Object.entries(values).forEach(([key, value]) => {
            ...
            // Skip type because it's always 0 for optins
            if (key === "type") return;
    ...
    const formatFiltersForApi = (values) => {
        ...
        // Always include type=0 for optins
        filters.type = 0;
        ...
        >
            <Form form={form} layout="vertical" initialValues={{}}>
                ...
                <div style={{ marginBottom: 24 }}>
                    ...
                    <Form.Item name="title" label="Optin Title">
                        <Input placeholder="Search by optin title" />
                    </Form.Item>
                    ...
                    <Form.Item name="link" label="Link">
                        <Input placeholder="Search by link" />
                    </Form.Item>
...
export default ManageOptinsSearchFilterDrawer;
