// src/components/CategoriesTableComponent/CategoriesSearchFilterDrawer.jsx
...
const CategoriesSearchFilterDrawer = ({
    open,
    onClose,
    filterConfig,
    sortOptions,
    ...
    const formatInitialValues = (values) => {
        ...
        Object.entries(values).forEach(([key, value]) => {
            ...
            // Skip type because it's always 3 for categories
            if (key === "type") return;
    ...
    const formatFiltersForApi = (values) => {
        ...
        // Always include type=3 for categories
        filters.type = 3;
...
export default CategoriesSearchFilterDrawer;
