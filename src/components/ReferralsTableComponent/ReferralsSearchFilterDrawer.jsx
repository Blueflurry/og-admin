// src/components/ReferralsTableComponent/ReferralsSearchFilterDrawer.jsx
...
const ReferralsSearchFilterDrawer = ({
    open,
    onClose,
    filterConfig,
    sortOptions,
        ...
        <Drawer
            title={
                <div style={{ display: "flex", alignItems: "center" }}>
                    ...
                    <span>Search & Filter Referrals</span>
                </div>
            }
            width={480}
            onClose={onClose}
...
export default ReferralsSearchFilterDrawer;
